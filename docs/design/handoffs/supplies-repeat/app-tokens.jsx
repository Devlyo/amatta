...
const AMATTA = {
  ...
  // ─── Type roles ───────────────────────────────────────────────────────
  // fontDisplay = Paperlogy — 화면 타이틀 + 섹션 헤더 전용 (그 외 전부 fontText)
  // fontText    = Pretendard — 본문·UI·자녀 이름·숫자 등 나머지 전부
  fontDisplay: '"Paperlogy", "Pretendard", -apple-system, system-ui, sans-serif',
  fontText: '"Pretendard", -apple-system, system-ui, sans-serif'
};
