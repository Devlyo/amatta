    ...
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          <span style={{ fontSize: 22, fontWeight: 600, letterSpacing: -0.4, fontFamily: A.fontDisplay }}>오늘</span>
          <span style={{
        ...
        map(([k, label, n]) => {
          ...
          return (
            <button key={k} onClick={() => setTab(k)} style={{
              ...
              letterSpacing: -0.3, fontFamily: A.fontDisplay
...
{ time: '15:30', who: '서윤', what: '미술', eta: '1h 10m',
  bg: '#A5DC85', titleColor: '#1d1d1b', titleSize: 14, eyebrowColor: '#1d1d1b',
  car: { body: '#FFFFFF', win: '#FFE2D0', wheel: '#1d1d1b', hub: '#FFFFFF', shine: 'rgba(255,255,255,0.95)' } },
{ time: '15:30', who: '서아', what: '어린이집', eta: '1h 10m',
  bg: '#A9C8F5', titleColor: '#1d1d1b', titleSize: 14, eyebrowColor: '#1d1d1b',
  car: { body: '#FFFFFF', win: '#FFF0C2', wheel: '#1d1d1b', hub: '#FFFFFF', shine: 'rgba(255,255,255,0.95)', shape: 'round' } }];
          ...
          return (
            ...
            onMouseLeave={(e) => e.currentTarget.style.background = A.ink04}>
              ...
              <div style={{
                ...
                fontSize: "13px", fontWeight: "500", fontFamily: A.fontText
              }}>
                {k.name}
...
function TodoB({ primary: primaryProp }) {
  ...
  <div style={{
    ...
    padding: '14px 4px 8px', fontFamily: '"Pretendard", sans-serif'
      ...
      <div style={{ fontSize: 16, fontWeight: 600, letterSpacing: -0.4, whiteSpace: 'nowrap', fontFamily: A.fontDisplay }}>{label}</div>
      <div style={{
          ...
          return (
            <React.Fragment key={kid.id}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: 13, fontWeight: 700, color: A.ink, letterSpacing: -0.3, whiteSpace: 'nowrap', fontFamily: A.fontText }}>{kid.name}</div>
                <div style={{
