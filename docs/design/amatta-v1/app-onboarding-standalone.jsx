...
const ONB_AVATARS = ['face-wink', 'face-dizzy', 'face-cool', 'face-sleep', 'face-surprise', 'face-calm']; // 6개 — face-happy(주황) 제외 (DS §10 Q7)
    ...
    <div style={{ ...{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img src={window.__resources.mascotPink} alt="" style={{
            objectFit: 'contain', width: "120px", height: "120px",
            position: 'relative', zIndex: 1
          }} />
          <img src={window.__resources.mascotOrange} alt="주황이" style={{
